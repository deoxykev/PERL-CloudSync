...
sub getList(*$){
	...
	if ($URL eq ''){
		$URL = 'https://www.googleapis.com/drive/v2/files?q=sharedWithMe%3Dfalse+and+trashed%3Dfalse&fields=nextLink%2Citems(kind%2Cid%2CmimeType%2Ctitle%2CfileSize%2CmodifiedDate%2CcreatedDate%2CdownloadUrl%2Cparents/parentLink%2Cmd5Checksum)';
	}
